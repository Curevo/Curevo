...
const Sidebar = () => {
    ...
    const navItems = [
        { icon: <UserPen  size={20} />, label: "Doctor Profiles" },
        { icon: <Pill size={20} />, label: "Product details" },
        { icon: <Mails size={20} />, label: "Newsletters" },
        { icon: <CalendarHeart size={20} />, label: "Appointments" },
        ...
        >
            <div className="flex flex-col justify-center">
                ...
                <div className="flex justify-between items-center mb-8 md:hidden">
                    <img src="/Curevo-logo.png" alt="" className="h-10"/>
                    <button
            ...
            {/* Logout */}
            <button className="flex items-center bg-gray-200 gap-2 text-red-500 hover:bg-red-100 px-3 py-2 rounded-md transition">
...
const NavItem = ({ icon, label }) => (
    <button className="flex items-center gap-3 text-gray-700 bg-gray-200 hover:bg-gray-300 px-3 py-5 rounded-md transition">
        {icon} {label}
    </button>
);
