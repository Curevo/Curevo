...
const ContactCTA = () => {
    return (
        ...
        <div className="max-w-7xl mx-auto text-center md:text-left">
            ...
            <a
                href="tel:+2395550104"
                className="w-fit inline-flex items-center bg-white border border-black hover:border-blue-500 text-black hover:text-white rounded-full px-2 py-2 text-sm font-medium shadow-sm hover:bg-blue-500 duration-300 transition"
            >
